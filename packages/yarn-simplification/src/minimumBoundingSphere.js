...
var minimumBoundingSphere = (() => {
  var _scriptDir = import.meta.url;
  
  return (
function(minimumBoundingSphere) {
  minimumBoundingSphere = minimumBoundingSphere || {};
...
var Module = typeof minimumBoundingSphere != 'undefined' ? minimumBoundingSphere : {};
...
var wasmBinaryFile;
if (Module['locateFile']) {
  wasmBinaryFile = 'minimumBoundingSphere.wasm';
  if (!isDataURI(wasmBinaryFile)) {
    wasmBinaryFile = locateFile(wasmBinaryFile);
  }
} else {
  // Use bundler-friendly `new URL(..., import.meta.url)` pattern; works in browsers too.
  wasmBinaryFile = new URL('minimumBoundingSphere.wasm', import.meta.url).toString();
}
...
run();
  ...
  return minimumBoundingSphere.ready
}
);
})();
export default minimumBoundingSphere;